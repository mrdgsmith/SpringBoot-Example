...
public class ExternalLink {
    ...
    public static final class ExternalLinkBuilder {
        ...
        public ExternalLinkBuilder withModified(LocalDateTime modified) {
            this.modified = modified;
            return this;
        }

        public ExternalLinkBuilder withUrl(String url) {
            this.url = url;
            return this;
        }

        public ExternalLinkBuilder withDescription(String description) {
            this.description = description;
            return this;
        }
